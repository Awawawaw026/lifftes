    ...
    if (!tipe) {
        ...
        document.getElementById('textx').addEventListener('click', function () {
            ...
            liff.sendMessages([{
                ...
                text: atob('bGluZTovL2FwcC8xNjM2MzYxMTc5LU45ZG5ScFlnP3R5cGU9Zm90ZXh0JnRleHQ9VFJJTyUyMFBFS09LJTIwQk9UU1xuXG50eXBlID0+IGZvdGV4dFxudGV4dCA9PiB5b3VyIHRleHQ=')
        ...
        document.getElementById('imagex').addEventListener('click', function () {
            ...
            liff.sendMessages([{
                ...
                text: atob('bGluZTovL2FwcC8xNjM2MzYxMTc5LU45ZG5ScFlnP3R5cGU9Zm9pbWFnZSZpbWc9aHR0cHM6Ly9pLmliYi5jby9UcjFtallILzE1NDU5NDY0NzQ0NzQuanBnXG5cbnR5cGUgPT4gZm9pbWFnZSBpbWFnZVxuaW1nID0+IExpbmsgKG11c3QgYmUgSFRUUFMp')
        ...
        document.getElementById('videox').addEventListener('click', function () {
            ...
            liff.sendMessages([{
                ...
                text: atob('bGluZTovL2FwcC8xNjM2MzYxMTc5LU45ZG5ScFlnP3R5cGU9dmlkZW8mb2N1PWh0dHBzOi8vdGlueXVybC5jb20veThvZzNvcjUmcGl1PWh0dHBzOi8vaS5pYmIuY28vVHIxbWpZSC8xNTQ1OTQ2NDc0NDc0LmpwZ1xuXG50eXBlID0+IHZpZGVvXG5vY3UgPT4gdmlkZW8gdXJsXG5waXUgPT4gcHJldmlldyBpbWFnZQ==')
        ...
        document.getElementById('audiox').addEventListener('click', function () {
            ...
            liff.sendMessages([{
                ...
                text: atob('bGluZTovL2FwcC8xNjM2MzYxMTc5LU45ZG5ScFlnP3R5cGU9YXVkaW8mbGluaz1odHRwczovL3BsYXRlbGV0cy5mdW4vcHVibGljL3NvdW5kcy9tdXNpYy5tcDNcblxubGluayAtIG11c3QgYmUgSFRUUFM=')
        ...
        document.getElementById('stickerx').addEventListener('click', function () {
            ...
            liff.sendMessages([{
                ...
                text: atob('')
                ...
                template: {
                    ...
                    actions: [

                        {
                            ...
                            uri:"line://app/1636361179-N9dnRpYg?type=profile"
